...
set(Qt5Multimedia_VERSION_STRING 5.13.0)
...
if (NOT TARGET Qt5::Multimedia)
    ...
    set(_Qt5Multimedia_OWN_INCLUDE_DIRS
      "${_qt5Multimedia_install_prefix}/lib/QtMultimedia.framework"
      "${_qt5Multimedia_install_prefix}/lib/QtMultimedia.framework/Headers"
    )
    set(Qt5Multimedia_PRIVATE_INCLUDE_DIRS
        "${_qt5Multimedia_install_prefix}/lib/QtMultimedia.framework/Versions/5/Headers/5.13.0/"
        "${_qt5Multimedia_install_prefix}/lib/QtMultimedia.framework/Versions/5/Headers/5.13.0/QtMultimedia"
    )
    ...
    foreach(_module_dep ${_Qt5Multimedia_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5Multimedia_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Multimedia PROPERTY FRAMEWORK 1)
    ...
    _populate_Multimedia_target_properties(RELEASE "QtMultimedia.framework/QtMultimedia" "" )
