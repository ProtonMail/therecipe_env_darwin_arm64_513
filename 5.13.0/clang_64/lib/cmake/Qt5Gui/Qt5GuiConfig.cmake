...
if (NOT TARGET Qt5::Gui)
    ...
    set(_Qt5Gui_OWN_INCLUDE_DIRS
      "${_qt5Gui_install_prefix}/lib/QtGui.framework"
      "${_qt5Gui_install_prefix}/lib/QtGui.framework/Headers"
    )
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/lib/QtGui.framework/Versions/5/Headers/5.13.0/"
        "${_qt5Gui_install_prefix}/lib/QtGui.framework/Versions/5/Headers/5.13.0/QtGui"
    )
    ...
    set_property(TARGET Qt5::Gui PROPERTY FRAMEWORK 1)
    ...
    _populate_Gui_target_properties(RELEASE "QtGui.framework/QtGui" "" )
