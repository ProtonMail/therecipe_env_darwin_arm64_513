...
set(Qt5Qml_VERSION_STRING 5.13.0)
...
if (NOT TARGET Qt5::Qml)
    ...
    set(_Qt5Qml_OWN_INCLUDE_DIRS
      "${_qt5Qml_install_prefix}/lib/QtQml.framework"
      "${_qt5Qml_install_prefix}/lib/QtQml.framework/Headers"
    )
    set(Qt5Qml_PRIVATE_INCLUDE_DIRS
        "${_qt5Qml_install_prefix}/lib/QtQml.framework/Versions/5/Headers/5.13.0/"
        "${_qt5Qml_install_prefix}/lib/QtQml.framework/Versions/5/Headers/5.13.0/QtQml"
    )
    ...
    foreach(_module_dep ${_Qt5Qml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5Qml_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Qml PROPERTY FRAMEWORK 1)
    ...
    _populate_Qml_target_properties(RELEASE "QtQml.framework/QtQml" "" )
