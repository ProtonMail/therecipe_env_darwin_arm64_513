...
set(Qt5Concurrent_VERSION_STRING 5.13.0)
...
if (NOT TARGET Qt5::Concurrent)
    ...
    set(_Qt5Concurrent_OWN_INCLUDE_DIRS
      "${_qt5Concurrent_install_prefix}/lib/QtConcurrent.framework"
      "${_qt5Concurrent_install_prefix}/lib/QtConcurrent.framework/Headers"
    )
    ...
    foreach(_module_dep ${_Qt5Concurrent_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5Concurrent_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Concurrent PROPERTY FRAMEWORK 1)
    ...
    _populate_Concurrent_target_properties(RELEASE "QtConcurrent.framework/QtConcurrent" "" )
