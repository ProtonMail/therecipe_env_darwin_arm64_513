...
set(Qt5Help_VERSION_STRING 5.13.0)
...
if (NOT TARGET Qt5::Help)
    ...
    set(_Qt5Help_OWN_INCLUDE_DIRS
      "${_qt5Help_install_prefix}/lib/QtHelp.framework"
      "${_qt5Help_install_prefix}/lib/QtHelp.framework/Headers"
    )
    set(Qt5Help_PRIVATE_INCLUDE_DIRS
        "${_qt5Help_install_prefix}/lib/QtHelp.framework/Versions/5/Headers/5.13.0/"
        "${_qt5Help_install_prefix}/lib/QtHelp.framework/Versions/5/Headers/5.13.0/QtHelp"
    )
    ...
    foreach(_module_dep ${_Qt5Help_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5Help_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Help PROPERTY FRAMEWORK 1)
    ...
    _populate_Help_target_properties(RELEASE "QtHelp.framework/QtHelp" "" )
