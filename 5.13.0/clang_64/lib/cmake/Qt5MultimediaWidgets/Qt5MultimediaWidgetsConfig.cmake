...
set(Qt5MultimediaWidgets_VERSION_STRING 5.13.0)
...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    set(_Qt5MultimediaWidgets_OWN_INCLUDE_DIRS
      "${_qt5MultimediaWidgets_install_prefix}/lib/QtMultimediaWidgets.framework"
      "${_qt5MultimediaWidgets_install_prefix}/lib/QtMultimediaWidgets.framework/Headers"
    )
    set(Qt5MultimediaWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaWidgets_install_prefix}/lib/QtMultimediaWidgets.framework/Versions/5/Headers/5.13.0/"
        "${_qt5MultimediaWidgets_install_prefix}/lib/QtMultimediaWidgets.framework/Versions/5/Headers/5.13.0/QtMultimediaWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5MultimediaWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5MultimediaWidgets_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::MultimediaWidgets PROPERTY FRAMEWORK 1)
    ...
    _populate_MultimediaWidgets_target_properties(RELEASE "QtMultimediaWidgets.framework/QtMultimediaWidgets" "" )
