...
set(Qt5QuickControls2_VERSION_STRING 5.13.0)
...
if (NOT TARGET Qt5::QuickControls2)
    ...
    set(_Qt5QuickControls2_OWN_INCLUDE_DIRS
      "${_qt5QuickControls2_install_prefix}/lib/QtQuickControls2.framework"
      "${_qt5QuickControls2_install_prefix}/lib/QtQuickControls2.framework/Headers"
    )
    set(Qt5QuickControls2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickControls2_install_prefix}/lib/QtQuickControls2.framework/Versions/5/Headers/5.13.0/"
        "${_qt5QuickControls2_install_prefix}/lib/QtQuickControls2.framework/Versions/5/Headers/5.13.0/QtQuickControls2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickControls2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5QuickControls2_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::QuickControls2 PROPERTY FRAMEWORK 1)
    ...
    _populate_QuickControls2_target_properties(RELEASE "QtQuickControls2.framework/QtQuickControls2" "" )
