...
set(Qt5OpenGLExtensions_VERSION_STRING 5.13.0)
...
function(_qt5_OpenGLExtensions_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt5OpenGLExtensions_install_prefix}/lib" ABSOLUTE)
...
macro(_populate_OpenGLExtensions_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if(NOT CMAKE_VERSION VERSION_LESS "3.13")
        set_target_properties(Qt5::OpenGLExtensions PROPERTIES
            "INTERFACE_LINK_OPTIONS" "${_Qt5OpenGLExtensions_STATIC_${Configuration}_LINK_FLAGS}"
        )
    endif()
    ...
    foreach(_module_dep ${_Qt5OpenGLExtensions_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5OpenGLExtensions_FIND_VERSION_EXACT}
