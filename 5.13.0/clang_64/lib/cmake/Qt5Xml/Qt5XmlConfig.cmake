...
set(Qt5Xml_VERSION_STRING 5.13.0)
...
if (NOT TARGET Qt5::Xml)
    ...
    set(_Qt5Xml_OWN_INCLUDE_DIRS
      "${_qt5Xml_install_prefix}/lib/QtXml.framework"
      "${_qt5Xml_install_prefix}/lib/QtXml.framework/Headers"
    )
    set(Qt5Xml_PRIVATE_INCLUDE_DIRS
        "${_qt5Xml_install_prefix}/lib/QtXml.framework/Versions/5/Headers/5.13.0/"
        "${_qt5Xml_install_prefix}/lib/QtXml.framework/Versions/5/Headers/5.13.0/QtXml"
    )
    ...
    foreach(_module_dep ${_Qt5Xml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5Xml_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Xml PROPERTY FRAMEWORK 1)
    ...
    _populate_Xml_target_properties(RELEASE "QtXml.framework/QtXml" "" )
