...
set(Qt5Sql_VERSION_STRING 5.13.0)
...
if (NOT TARGET Qt5::Sql)
    ...
    set(_Qt5Sql_OWN_INCLUDE_DIRS
      "${_qt5Sql_install_prefix}/lib/QtSql.framework"
      "${_qt5Sql_install_prefix}/lib/QtSql.framework/Headers"
    )
    set(Qt5Sql_PRIVATE_INCLUDE_DIRS
        "${_qt5Sql_install_prefix}/lib/QtSql.framework/Versions/5/Headers/5.13.0/"
        "${_qt5Sql_install_prefix}/lib/QtSql.framework/Versions/5/Headers/5.13.0/QtSql"
    )
    ...
    foreach(_module_dep ${_Qt5Sql_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5Sql_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Sql PROPERTY FRAMEWORK 1)
    ...
    _populate_Sql_target_properties(RELEASE "QtSql.framework/QtSql" "" )
