...
set(Qt5Quick_VERSION_STRING 5.13.0)
...
if (NOT TARGET Qt5::Quick)
    ...
    set(_Qt5Quick_OWN_INCLUDE_DIRS
      "${_qt5Quick_install_prefix}/lib/QtQuick.framework"
      "${_qt5Quick_install_prefix}/lib/QtQuick.framework/Headers"
    )
    set(Qt5Quick_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick_install_prefix}/lib/QtQuick.framework/Versions/5/Headers/5.13.0/"
        "${_qt5Quick_install_prefix}/lib/QtQuick.framework/Versions/5/Headers/5.13.0/QtQuick"
    )
    ...
    foreach(_module_dep ${_Qt5Quick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5Quick_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Quick PROPERTY FRAMEWORK 1)
    ...
    _populate_Quick_target_properties(RELEASE "QtQuick.framework/QtQuick" "" )
