...
set(Qt5DBus_VERSION_STRING 5.13.0)
...
if (NOT TARGET Qt5::DBus)
    ...
    set(_Qt5DBus_OWN_INCLUDE_DIRS
      "${_qt5DBus_install_prefix}/lib/QtDBus.framework"
      "${_qt5DBus_install_prefix}/lib/QtDBus.framework/Headers"
    )
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/lib/QtDBus.framework/Versions/5/Headers/5.13.0/"
        "${_qt5DBus_install_prefix}/lib/QtDBus.framework/Versions/5/Headers/5.13.0/QtDBus"
    )
    ...
    foreach(_module_dep ${_Qt5DBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5DBus_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::DBus PROPERTY FRAMEWORK 1)
    ...
    _populate_DBus_target_properties(RELEASE "QtDBus.framework/QtDBus" "" )
